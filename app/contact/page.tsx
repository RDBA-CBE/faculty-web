        ...
        <div className="md:col-span-5">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600">support@facultyweb.com</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-600">123 Academic Way, Knowledge City, ED 45678</p>
            </div>
          </div>
        </div>
        ...
        <div className="md:col-span-7">
          <div className="bg-white shadow-lg rounded-lg p-8 border border-gray-100">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white font-bold py-3 px-4 rounded-md hover:bg-blue-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              >
                Send Message
              </button>
            </form>
