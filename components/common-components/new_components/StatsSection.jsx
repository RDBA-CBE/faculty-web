      ...
      <div className="section-wid w-full px-4 sm:px-6 lg:px-8 xl:px-0 relative z-10">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center gap-2 flex flex-col">
            <h3 className="text-5xl lg:text-6xl font-bold text-white mb-2" style={{ WebkitTextStroke: '2px white', WebkitTextFillColor: 'transparent' }}>
              500+
            </h3>
            <p className="text-white text-lg font-medium">Jobs Available</p>
          </div>
          ...
          <div className="text-center gap-2 flex flex-col">
            ...
            <p className="text-white text-lg font-medium">Institutions</p>
          </div>
          ...
          <div className="text-center gap-2 flex flex-col">
            ...
            <p className="text-white text-lg font-medium">Resumes</p>
          </div>
          ...
          <div className="text-center gap-2 flex flex-col">
            ...
            <p className="text-white text-lg font-medium">Members</p>
          </div>
        </div>
      </div>
    </section>
