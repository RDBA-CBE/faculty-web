  ...
  return (
    <section className="relative bg-[#f9fafb] py-20 lg:py-28">
      <div className="section-wid w-full flex flex-col items-center text-center">
        <h1 className="text-4xl lg:text-6xl font-bold text-[#01014B] mb-6">
        ...
        <div className="bg-white rounded-full shadow-lg border border-gray-200 p-2 flex flex-col sm:flex-row items-center gap-2 w-full max-w-3xl relative z-10">
          ...
          <button
            ...
            className="bg-[#01014B] text-white px-8 py-3 rounded-full text-base font-medium hover:bg-[#080f3d] transition w-full sm:w-auto"
          >
            Find Job
          </button>
        </div>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4 text-sm text-gray-500">
          ...
          {['Assistant Professor', 'Research Associate', 'Dean'].map((term) => (
            <span
              ...
              className="bg-white px-3 py-1 rounded-full border border-gray-200 cursor-pointer hover:border-[#01014B] transition"
            >
              {term}
            </span>
          ))}
